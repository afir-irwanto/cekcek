...
<div class="container">
    ...
    <form action="{{ route('mahasiswa.insert') }}" method="POST">
        ...
        <div class="mb-3">
            <label for="asal_kampus" class="form-label" enctype="multipart/form-data">PROPOSAL</label>
            <input name="proposal" type="file" class="form-control" placeholder="Upload File Proposal" id="" aria-describedby="">
        </div>
        <div class="mb-3">
            <label for="asal_kampus" class="form-label" enctype="multipart/form-data">SURAT PENGANTAR</label>
            <input name="suratpengantar" type="file" class="form-control" placeholder="Upload File Surat Pengantar" id="" aria-describedby="">
        </div>
